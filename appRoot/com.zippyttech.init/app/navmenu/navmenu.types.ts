...
export class NavItem{
    ...
    public getItem(title:string):NavItem{ return this.items[this.indexOf[title]]; }
    public get items(){ return this.params.items; }
    public get title(){ return this.params.title; }
    public get icon(){ return this.params.icon; }
    public get selectedItem():number{ return this._selectedItem; }
    public get permission(){ return this.params.permission; }
    public get routerLink(){ return this.params.routerLink; }

    public click(itemSelect:number){
        this._selectedItem = (this._selectedItem==itemSelect)?-1:itemSelect;
